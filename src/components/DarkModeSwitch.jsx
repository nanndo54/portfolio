/*
  ORIGINAL COMPONENT FROM JoseRFelix
  Took from release (https://github.com/JoseRFelix/react-toggle-dark-mode/releases/tag/v1.0.4) due to an incompatibility between Vite and the npm package react-toggle-dark-mode
  All credis to him
*/
