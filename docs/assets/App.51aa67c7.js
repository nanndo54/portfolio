...
import { d as p } from './index.64cb0310.js'
var g = 'App_base_1',
  m = 'App_sections_8'
var f = {
  base: 'Navbar_base_1',
...
function I() {
  x < 0 && ((x = 0), 'demand' !== y.frameLoop && B(P))
}
function P() {
  ~x && (B(P), y.batchedUpdates(S))
}
function S() {
  let e = x
  x = y.now()
...
class $t extends Mt {
  ...
  _merge(e, t, n) {
    ...
    ;(r || o) && (g.velocity = 0),
      t.config &&
        !p &&
        (function (e, t, n) {
          n && (St((n = gt({}, n)), t), (t = gt({}, n, t))), St(e, t), Object.assign(e, t)
  ...
  _attach() {
    let e = 0
    const { to: t } = this.animation
    Be(t) && (Se(t, this), Yt(t) && (e = t.priority + 1)), (this.priority = e)
  }
  _detach() {
...
class On extends Mt {
  ...
  advance(e) {
    ...
    H(t, this.get()) || ($e(this).setValue(t), this._onChange(t, this.idle)),
      !this.idle && Pn(this._active) && Sn(this)
  }
  _get() {
  ...
  _start() {
    this.idle &&
      ...
      W.skipAnimation
        ? (y.batchedUpdates(() => this.advance()), Sn(this))
        : ee.start(this))
  }
  _attach() {
    let e = 1
...
class Tn extends Ie {
  ...
  observerAdded(e) {
    1 == e && N(this.inputs, (e) => N(e, (e) => Be(e) && Se(e, this)))
  }
  observerRemoved(e) {
...
function br({
  ...
  const s = c.exports.useRef(null),
    ...
    })(s, { threshold: 0.4, fallback: n }),
    i = `${cr} ${e ? dr : ''} ${n ? (t && a ? ur : '') : t ? ur : ''}`
  return d.createElement(
    d.Fragment,
    null,
    d.createElement(
...
var Ir = 'ProjectsSection_projects_1'
var Pr = 'Project_base_1',
  Sr = 'Project_expanded_29',
  Rr = 'Project_down_33'
function Ur({ name: e, description: t, technologies: n = [] }) {
...
function qr() {
  ...
  return d.createElement(
    ...
    d.createElement(
      'div',
      { className: Ir },
      d.createElement(Ur, { name: 'Testing avanzado', url: '#', description: e }),
      d.createElement(Ur, { name: 'Proyecto nuevo', url: '#', description: e })
    )
  )
}
function Fr() {
